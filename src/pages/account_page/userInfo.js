...
export default function Info() {
    ...
    const [valid, setValid] = useState(new Date(userInfo.validUntil).toLocaleDateString('pt-PT'))
    ...
    useEffect(() => {
        ...
        setBirth(new Date(userInfo.birth).toLocaleDateString('fr-CA'))
        setAddress(userInfo.address)
        setValid(new Date(userInfo.validUntil).toLocaleDateString('pt-PT'))
        ...
        <div className="info-page">
            <div className="info-User">
                ...
                <div className="ending-row">
                    ...
                    <div className="refresh-btn-Edit" onClick={e => setUserInfo({ ...userInfo })}>Hoàn tác</div>
